...
export default function AboutUs() {
  return (
    <div className="flex items-center justify-center px-4 md:px-10 py-16" id="AboutUs">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10  xl:gap-15 md:gap-24 items-center">
        {/* Image Section */}
        <div className="relative hidden md:block w-full max-w-[400px] xl:w-[500px] xl:h-[500px] lg:max-w-[800px] h-[400px] lg:h-[800px]">
          <Image
            src="/Favor.webp"
            alt="Parfum Favor"
            layout="fill"
        ...
        {/* Text Section */}
        <div className="text-left w-full max-w-[600px] xl:w-[500px]">
          <h2 className="text-transparent bg-gradient-to-r from-gray-600 via-white to-white bg-clip-text xl:text-3xl text-4xl md:text-5xl font-medium mb-6 md:mb-10">
            ABOUT US
          </h2>
          <p className="text-gray-700 text-lg md:text-2xl xl:text-base leading-relaxed">
